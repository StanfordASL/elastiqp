...
NB_MODULE(_core, m) {
  ...
  nb::class_<Settings>(m, "Settings")
      ...
      .def_rw("bcl_saturation_jump", &Settings::bcl_saturation_jump)
      .def_rw("bcl_release_jump", &Settings::bcl_release_jump)
      .def_rw("bcl_release_jump_horizon", &Settings::bcl_release_jump_horizon)
